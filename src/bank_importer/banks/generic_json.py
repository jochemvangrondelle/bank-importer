...
class GenericJsonParser(Parser):
    ...
    def _parse_transaction(
        ...
        try:
            ...
            log_error(f"Error parsing transaction {item_num}: {e}")
            return None
    ...
    def _parse_date(self, date_value: object) -> datetime | None:
    ...
    def _parse_amount(self, amount_value: object) -> Decimal | None:
