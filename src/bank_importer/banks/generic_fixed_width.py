...
class GenericFixedWidthParser(Parser):
        ...
        try:
            with file_path.open(encoding="utf-8") as file:
                ...
                if not field_positions:
                    msg = "Could not detect field positions"
                ...
                for line_num, line in enumerate(lines, start=1):
                    ...
                    try:
                        ...
                        log_error(f"Error parsing line {line_num} in {file_path}: {e}")
                        continue

        except Exception as e:
            msg = "Error parsing fixed-width file"
    ...
    def _parse_line(
        ...
        try:
            ...
            log_error(f"Error parsing line {line_num}: {e}")
            return None
