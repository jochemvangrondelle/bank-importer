...
if TYPE_CHECKING:
    ...
    try:
        ...
        firefly_iii_api_client = lazy.load("firefly_iii_api_client")  # type: ignore[assignment]

        # Lazy load Rich (CLI formatting, only needed for CLI)
        rich = lazy.load("rich")  # type: ignore[assignment]
        rich_console = lazy.load("rich.console")  # type: ignore[assignment]
        rich_table = lazy.load("rich.table")  # type: ignore[assignment]
        ...
        import firefly_iii_api_client  # type: ignore[assignment]
        from rich import console as rich_console  # type: ignore[assignment]
        from rich import table as rich_table  # type: ignore[assignment]
