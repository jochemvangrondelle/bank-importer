...
""",
        ...
        with patch("bank_importer.cli.parameters.ConfigManager") as mock_config_class:
            mock_config = Mock()
...
class TestValidateAccount:
    ...
    def test_validate_account_valid(self) -> None:
        ...
        ctx = Mock()
        param = Mock()
        with patch("bank_importer.cli.parameters.get_available_accounts") as mock_get:
...
class TestLazyDependencies:
    ...
    def test_lazy_dependencies_processor(self, tmp_path: Path) -> None:
        ...
        try:
            os.environ["DATABASE_URL"] = f"duckdb:///{test_db}"
    ...
    def test_lazy_dependencies_db_manager(self, tmp_path: Path) -> None:
    ...
    def test_lazy_dependencies_db_manager_uses_processor(self, tmp_path: Path) -> None:
