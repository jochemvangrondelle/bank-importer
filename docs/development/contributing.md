...
1. **Fork the repository** on [GitHub](https://github.com/jochemvangrondelle/bank-importer)
...
**All commits must follow the [Conventional Commits](https://www.conventionalcommits.org/) specification.** This is enforced by pre-commit hooks and ensures beautiful changelog generation.
...
feat(parser): implement AMEX CSV parser
...
- **GitHub Issues**: [Open an issue](https://github.com/jochemvangrondelle/bank-importer/issues) for bugs and feature requests
- **GitHub Discussions**: [Start a discussion](https://github.com/jochemvangrondelle/bank-importer/discussions) for questions and ideas
